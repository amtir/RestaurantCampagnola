            ...
            $.ajax({
                ...
                error: function() {
                    ...
                    $('#success > .alert-danger').html("<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;")
                        .append("</button>");
                    $('#success > .alert-danger').append("<strong>Sorry, the mail server is not responding. Please call Hichem at 00216 98 111 444 or try again later!");
...
==============================================*/
    function loadGoogleMap() {
        ...
        var mapPoint = {
                    ...
                    'lng': 10.561480,
                    'zoom' : 14,
                    'infoText':'<p>GP1-KM10 route de tunis\
                                <br/>Sousse\
                                <br/>Tunisia</p>',
                    'linkText':'View on Google Maps',
                    'mapAddress':'GP1-KM10 route de tunis, Sousse, Tunisia',
